  ...
  return (
    <section className='flex-center size-full flex-col gap-3'>
        ...
        <div className='flex-center w-full max-w-[254px] flex-col gap-3'>
            ...
            {search && (
                <p className='text-16 text-center font-medium text-white-1'>Try adjusting your search to find what you are looking for</p>
            )}
            {buttonLink && (
                <Button className='bg-orange-1'>
                    <Link href={buttonLink} className='gap-1 flex'>
                        <Image
                            ...
                            alt='discover'
                        />
                        <h1 className='text-16 text-center font-extrabold text-white-1'>{buttonText}</h1>
                    </Link>
                </Button>
            )}
        </div>
