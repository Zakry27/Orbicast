  ...
  async function onSubmit(data: z.infer<typeof formSchema>) {
    try {
      ...
      if(!audioUrl || !imageUrl || !voiceType){
        toast({
          title: 'Please generate the audio and image',
          variant: 'destructive',
        })
        setIsSubmitting(false);
        throw new Error('Please generate the audio and image')
      }
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col gap-2.5">
                  ...
                  <FormControl>
                    <Textarea className="input-class focus-visible:ring-offset-orange-1" placeholder="Write a short descrition about the Podcast" {...field} />
                  </FormControl>
                  <FormMessage className="text-white-1"/>
                </FormItem>
              )}
